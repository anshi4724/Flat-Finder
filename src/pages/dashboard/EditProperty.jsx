  ...
  return (
    <div className="min-h-screen bg-slate-50 py-10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <Link to="/dashboard" className="inline-flex items-center text-sm text-slate-600 dark:text-slate-500 hover:text-indigo-600 mb-4 transition font-medium">
            <HiArrowLeft className="mr-1" /> Back to Dashboard
          </Link>
          <h1 className="text-3xl font-extrabold text-slate-800">Edit Property</h1>
          <p className="text-slate-600 dark:text-slate-500 mt-1">Update details for your listing</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
            ...
            <section>
              <h3 className="text-lg font-bold text-slate-800 mb-4 border-b pb-2 flex justify-between items-center">
                ...
                <span className="text-sm font-normal text-slate-600 dark:text-slate-500">{existingImages.length + newImages.length}/5 uploaded</span>
              </h3>
                ...
                <div className="mt-2">
                  ...
                  <div className="flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-xl hover:border-indigo-400 transition-colors bg-slate-50 group">
                    <div className="space-y-1 text-center">
                      <HiPhotograph className="mx-auto h-12 w-12 text-slate-600 dark:text-slate-400 group-hover:text-indigo-400 transition-colors" />
                      ...
                      <p className="text-xs text-slate-600 dark:text-slate-500">PNG, JPG, WEBP up to 5MB each. You can add {5 - (existingImages.length + newImages.length)} more.</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="pt-6 border-t border-slate-200 flex justify-end gap-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-slate-900 dark:text-white rounded-xl font-medium hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-70 disabled:cursor-not-allowed transition cursor-pointer"
              >
