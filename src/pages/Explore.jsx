...
const Explore = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#030712] text-slate-900 dark:text-white">
      {/* Header */}
      <div className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-indigo-400 text-[10px] font-black uppercase tracking-widest mb-4">
        ...
        {pagination && pagination.pages > 1 && (
          ...
          >
            <button
              ...
              className="p-3 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-white/10 disabled:opacity-20 disabled:cursor-not-allowed transition-all cursor-pointer shadow-xl"
            >
                ...
                <button
                  ...
                  className={`w-12 h-12 rounded-2xl font-black text-sm tracking-tight transition-all cursor-pointer ${
                    page === pagination.page
                      ...
                      : 'bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-white/10'
                  }`}
                >
                  {page}
                </button>
